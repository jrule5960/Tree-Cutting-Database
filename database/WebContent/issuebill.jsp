...
<body>
    ...
    <div class="form-container">
        ...
        <form action="issueBill" method="post">
        	<label for="quoteId">Client Email: </label>
            <input readonly value="${listQuote.clientEmail}" type="text" name="billId" id="billId" required><br><br>
